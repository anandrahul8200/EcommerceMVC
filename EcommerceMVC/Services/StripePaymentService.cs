...
namespace EcommerceMVC.Services
{
    public class StripePaymentService
    {
        ...
        {
            _secretKey = ConfigurationManager.AppSettings["Stripe:SecretKey"] ?? "sk_test_your_secret_key";
            _publishableKey = ConfigurationManager.AppSettings["Stripe:PublishableKey"] ?? "pk_test_your_publishable_key";
            _isTestMode = bool.Parse(ConfigurationManager.AppSettings["Stripe:TestMode"] ?? "true");
        }
